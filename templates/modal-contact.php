<div class="modal__container" id="modal-contact"  scrollbar>
	<section class="contact contact--grid contact--grow-md-bottom">
		<div class="contact__cell contact__cell--content contact__cell--shrink-double">
		...
		<div class="contact__cell contact__cell--shrink-double contact__cell--form" ng-form>
