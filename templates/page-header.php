<?php 
	...
	$lampade = get_posts(array('post_type'=>'lampade','posts_per_page'=>-1, 'orderby'=>'title', 'order' => 'ASC', 'tax_query' => array(array('taxonomy' => 'collezioni', 'field' => 'term_id', 'terms' => array($collection[0]->term_id)))));
