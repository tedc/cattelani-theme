...
include(locate_template( 'templates/form-header.php' )); 
...
<form id="contactForm" class="form" name="contactForm" ng-submit="submit(contactForm.$valid, '<?php echo $current_url; ?>')" novalidate>
	<input type="hidden" ng-init="formData.security_check='<?php echo generateRandomString(); ?>'" ng-model="formData.security_check" />
