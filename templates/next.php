<?php
 ...
 //                    );
	...
	$next = (get_post_type() == 'lampade' ) ? apto_get_adjacent_post( array('taxonomy' => 'collezioni', 'term_id' => $term[0]->term_id), true) : apto_get_adjacent_post( FALSE, FALSE, FALSE, FALSE);
