...
<form id="contactForm" class="form" name="contactForm" novalidate action="https://catellanismith.agilecrm.com/formsubmit" method="GET">
	...
	<input type="hidden" id="_agile_form_name" name="_agile_form_name" value="Kontakte">
...
<input type="hidden" id="_agile_redirect_url" name="_agile_redirect_url" value="https://www.catellanismith.com/de">
<input type="hidden" id="_agile_document_url" name="_agile_document_url" value="">
<input type="hidden" id="_agile_confirmation_msg" name="_agile_confirmation_msg" value="">
<input type="hidden" id="_agile_form_id_tags" name="tags" value="DE">

<input type="hidden" id="_agile_form_id" name="_agile_form_id" value="5675267779461120">
	</div>
	<p><input class="form__input" type="text" name="first_name" required ng-model="formData.first_name" placeholder="<?php _e('Vorname (obligatorisch)', 'catellani'); ?>"></p>
	<p><input class="form__input" type="text" name="last_name" required ng-model="formData.last_name" placeholder="<?php _e('Nachname (obligatorisch)', 'catellani'); ?>"></p>
	<p><input class="form__input" type="email" name="email" required ng-model="formData.email" placeholder="<?php _e('Email (addresse obligatorisch)', 'catellani'); ?>"></p>
	<p><input class="form__input" type="tel" name="phone" required ng-model="formData.tel" placeholder="<?php _e('Telefon (obligatorisch)', 'catellani'); ?>"></p>
	...
	<p><textarea class="form__textarea" name="note" ng-model="formData.message" placeholder="<?php _e('Nachricht', 'catellani'); ?>"></textarea></p>
	<em class="form__privacy"><?php _e('Mit dem ausgefüllten Formular in Anhang bestätige ich, dass ich die dass ich die Datenschutzstimmungen (D. Lg. 196/03) gelesen und akzeptiert habe.', 'catellani'); ?></em>
	<p class="form__footer">
		<button type="submit" class="form__send" ng-disabled="contactForm.$invalid">
			<span><?php _e('Senden', 'catellani'); ?></span>
		</button>
	</p>
</form>
