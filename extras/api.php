    ...
    function api_init() {
       ...
       // }
        ...
        function add_post_thumb($object) {
           ...
           return array('id'=>$id, 'alt' => $alt, 'magazine' => get_the_post_thumbnail_url( $id, 'magazine' ), 'large' => get_the_post_thumbnail_url( $id, 'large' ), 'full' => get_the_post_thumbnail_url( $id, 'full' ));
        }// POST THUMBNAIL
