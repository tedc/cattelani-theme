...
<div class="light light--shrink-fw light--grid">
	<figure class="light__cell light__cell--figure light__cell--s<?php echo (get_sub_field('foto_verticale')) ? 5 : 7; ?>" ng-light-mask ng-mousemove="moveMask($event, '#circle_<?php echo $row; ?>')">
