...
<div class="projects projects--grow-lg" post-type-archive post-type="<?php the_sub_field('post_type'); ?>" lang="<?php echo ICL_LANGUAGE_CODE; ?>">
	...
	<div class="projects__items projects__items--grow-lg projects__items--shrink-fw projects__items--grid">
		<span class="projects__cell projects__cell--found" ng-if="items.length <= 0 && firstLoad" ng-class="{'projects__cell--found-visible':firstLoad}"><span><?php _e('Ci dispiace, ma dai filtri che hai selezionato non risulta nessuna combinazione presente.<br/>Puoi scegliere se resettare i filtri ed esplorare le nostre realizzazioni oppure contattarci per creare assieme un nuovo fantastico progetto.', 'catellani'); ?></span></span>
