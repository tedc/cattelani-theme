<div class="collections" ng-swiper>
	...
	<ks-swiper-container class="collections__container collections__container--shrink" swiper="nav" loop="true" slides-per-view="'auto'" override-parameters="{'centeredSlides':true,'loopedSlides':1, 'slideToClickedSlide' : true, 'nextButton' : '.collections__nav .icon-arrow-next', 'prevButton' : '.collections__nav .icon-arrow-prev'}">
