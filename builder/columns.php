<div class="section section--shrink-fw section--grid section--grow-lg<?php echo (get_sub_field('column_right')) ? ' section--end' : ''; ?><?php echo (get_sub_field('background')) ? ' section--'.get_sub_field('background') : ''; ?>">
<?php 
$col = 0;
