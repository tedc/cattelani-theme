...
<form class="glossary-search glossary-search--shrink glossary-search--gray glossary-search--grow-md">
	<div class="glossary-search__box glossary-search__box--mw" glossary-autocomplete>
		<input type="glossary.search" ng-model="glossary.search" class="glossary-search__input" ng-change="glossary.searchTerms()" placeholder="<?php _e('Cerca termini', 'catellani'); ?>" ng-focus="glossary.isSearch = true" ng-model-options="{debounce:500}" />
