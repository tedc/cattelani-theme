...
?>
<ng-swiper>
<ks-swiper-container swiper="main" override-parameters="{'effect':'fade', 'fade' : {'crossFade' : true}}" show-nav-buttons="<?php echo count($images) > 1 ? 'true' : 'false'; ?>" ng-init="slider = [<?php echo $imgs; ?>]" loop="true"<?php if(count($images) > 1): ?> autoplay="5000"<?php endif; ?>>
