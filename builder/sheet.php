...
<section class="sheet sheet--shrink-fw sheet--grow-md sheet--gray">
	<div class="sheet__container sheet__container--grow-md">
		...
		<?php $c++; endwhile; ?>
		<div class="sheet__pdf sheet__pdf--mw sheet__pdf--grow-md-top" download-form><form ng-submit="download(<?php the_ID(); ?>)"><button class="sheet__send"><?php _e('Scarica la', 'catellani'); ?> <?php _e('Scheda tecnica', 'catellani'); ?></button></form></div>
	</div>
</section>
<?php endif; ?>